...
\input{Document-Structure/GlossarMetadaten.tex}

% Frontmatter
% \input{Document-Structure/01_Frontmatter/Abstract.tex}

% Mainmatter
\input{Document-Structure/02_Mainmatter/Introduction.tex}
\input{Document-Structure/02_Mainmatter/Background.tex}
\input{Document-Structure/02_Mainmatter/Creation.tex}
\input{Document-Structure/02_Mainmatter/Detection.tex}
\input{Document-Structure/02_Mainmatter/Conclusion.tex}
...
{\hypersetup{hidelinks}
    \printbibliography{}
    \printglossaries{}
    % \listoffigures  % removed, to few entries
    % \listoftables % removed, to few entries
}
\input{Document-Structure/03_Backmatter/Appendices.tex}
